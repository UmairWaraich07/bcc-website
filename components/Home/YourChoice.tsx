  ...
  return (
    <section className="mx-auto max-w-6xl py-10 sm:py-16">
      ...
      <div className="mt-12 flex flex-col items-center justify-center gap-10 md:mt-20 md:flex-row md:items-start md:gap-16">
        ...
        {/* Choice 2 */}
        <div className="flex flex-1 flex-col items-center justify-start text-center">
          <div className="mb-8 flex size-12 items-center justify-center rounded-full border-4 border-[#0054F6] shadow-[0_0_10px_rgba(0,84,254,0.7)]">
      ...
      <div className="mt-14 flex flex-col items-center justify-center text-center md:mt-24">
